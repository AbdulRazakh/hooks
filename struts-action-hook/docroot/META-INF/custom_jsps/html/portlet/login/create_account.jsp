...
<aui:form action="<%= createAccountURL %>" method="post" name="fm">
	...
	<aui:fieldset column="<%= true %>">
		...
		<aui:col width="<%= 50 %>">
			...
			<aui:input name="aboutMe" type="textarea" id="aboutMe"  label="About Me" placeholder="About Me">
				<aui:validator name="required" errorMessage="About Me required"></aui:validator>
			</aui:input>
